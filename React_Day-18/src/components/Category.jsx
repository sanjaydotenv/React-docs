...
const Category = ({ data }) => {
  ...
  const { setSelectedCategory } = ProductHook();
  ...
  return (
    <div className="flex items-center justify-center">
      <div
        onClick={handleClick}
        className="w-72 h-36 rounded-2xl bg-[#18181B] border border-zinc-800 p-6 flex flex-col justify-between hover:border-violet-500 hover:shadow-lg hover:shadow-violet-500/20 transition-all duration-300 cursor-pointer"
      >
        {/* Icon */}
